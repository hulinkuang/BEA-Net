...
import torch
import shutil
from nnunet.training.loss_functions.deep_supervision import NewLoss
...
from BEA.training.network_training.nnUNetTrainer import nnUNetTrainer
...
class nnUNetTrainerV2_ResTrans(nnUNetTrainer):
    ...
    def __init__(self, plans_file, fold, norm_cfg, activation_cfg, output_folder=None, dataset_directory=None,
                 batch_dice=True, stage=None,
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if force_load_plans or (self.plans is None):
                ...
                if self.norm_cfg == 'BN':
                    self.plans['plans_per_stage'][0]['batch_size'] = 8
    ...
    def initialize_network(self):
        ...
        self.network = ResTranUnet(norm_cfg=self.norm_cfg, activation_cfg=self.activation_cfg,
                                   num_classes=self.num_classes, deep_supervision=True).cuda()
