...
if __name__ == "__main__":
    dataset_dir = Path("/homec/kuanghl/Dataset/Kvasir/Kvasir-SEG")
    data_path = dataset_dir / "images"
    masks_path = dataset_dir / "masks"

    output_folder = Path("/homec/kuanghl/Codes/CoTr_KSR/nnUNet/nnU_data/nnUNet_raw_data_base/nnUNet_raw_data/Task02_Kvasir")
    ...
    for seg_path in masks_path.glob('*.jpg'):
    ...
    test_ids = [i.stem for i in Path("/homec/kuanghl/Dataset/Kvasir/Kvasir_test/images").glob('*.png')]
